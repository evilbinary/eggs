...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--cc=arm-none-eabi-gcc --ar=arm-none-eabi-ar --ranlib=arm-none-eabi-ranlib --enable-cross-compile --arch=arm --target-os=linux --extra-cflags='  -Ieggs/libgcc  -Ieggs/libgcc/include  -I../libmusl  -I../libmusl/include  -Ieggs/libm  -Ieggs/libm/include  -I.  -Ieggs/include/  -I../libmusl  -I../libmusl/include  -I../libmusl/obj/include/  -I../libmusl/arch/generic/  -I../libmusl/arch/generic/bits  -I../libmusl/arch/arm/  -I../libmusl/arch/arm/bits -fstack-protector -g -DDUCK -DARM -DARMV7_A -nostdlib -nostdinc -fPIC -fno-builtin -std=c99 -std=gnu99 -w -DRASPI2 -mcpu=cortex-a7 -mtune=cortex-a7 -mfpu=vfpv4 -mfloat-abi=softfp  -nostdlib -nostdinc --specs=nosys.specs  -DDUCK  -D__LIB_MUSL__ -Wl,-dynamic-linker,/lib/ld-musl-armv7-a.so    -Leggs/libm  -Leggs/libm/lib  -L../libmusl  -L../libmusl/lib  -Leggs/libgcc  -Leggs/libgcc/lib  -L.  -L/opt/local/lib/gcc/arm-none-eabi/8.3.0/  -lmusl  -lm  -lgcc' --extra-ldflags='-nostdlib -nostartfiles -e _start  -g  -mcpu=cortex-a7 -mtune=cortex-a7 -mfpu=vfpv4 -mfloat-abi=softfp  ../libmusl/lib/crt1.o ../libmusl/lib/libc.a  -Leggs/libm  -Leggs/libm/lib  -L../libmusl  -L../libmusl/lib  -Leggs/libgcc  -Leggs/libgcc/lib  -L.  -L/opt/local/lib/gcc/arm-none-eabi/8.3.0/  -lmusl  -lm  -lgcc  ' --host-extralibs= --enable-gpl --enable-nonfree --enable-static --disable-programs --disable-stripping --disable-doc --disable-pthreads --disable-shared --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-vfp --disable-inline-asm --disable-dct --disable-asm --disable-network
prefix=/usr/local
...
CFLAGS=  -Ieggs/libgcc -Ieggs/libgcc/include -I../libmusl -I../libmusl/include -Ieggs/libm -Ieggs/libm/include -I. -Ieggs/include/ -I../libmusl -I../libmusl/include -I../libmusl/obj/include/ -I../libmusl/arch/generic/ -I../libmusl/arch/generic/bits -I../libmusl/arch/arm/ -I../libmusl/arch/arm/bits -fstack-protector -g -DDUCK -DARM -DARMV7_A -nostdlib -nostdinc -fPIC -fno-builtin -std=c99 -std=gnu99 -w -DRASPI2 -mcpu=cortex-a7 -mtune=cortex-a7 -mfpu=vfpv4 -mfloat-abi=softfp -nostdlib -nostdinc --specs=nosys.specs -DDUCK -D__LIB_MUSL__ -Wl,-dynamic-linker,/lib/ld-musl-armv7-a.so -Leggs/libm -Leggs/libm/lib -L../libmusl -L../libmusl/lib -Leggs/libgcc -Leggs/libgcc/lib -L. -L/opt/local/lib/gcc/arm-none-eabi/8.3.0/ -lmusl -lm -lgcc -march=armv7-a -std=c11 -fomit-frame-pointer -fPIC -marm -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
OBJCFLAGS=  
ASFLAGS=  -Ieggs/libgcc -Ieggs/libgcc/include -I../libmusl -I../libmusl/include -Ieggs/libm -Ieggs/libm/include -I. -Ieggs/include/ -I../libmusl -I../libmusl/include -I../libmusl/obj/include/ -I../libmusl/arch/generic/ -I../libmusl/arch/generic/bits -I../libmusl/arch/arm/ -I../libmusl/arch/arm/bits -fstack-protector -g -DDUCK -DARM -DARMV7_A -nostdlib -nostdinc -fPIC -fno-builtin -std=c99 -std=gnu99 -w -DRASPI2 -mcpu=cortex-a7 -mtune=cortex-a7 -mfpu=vfpv4 -mfloat-abi=softfp -nostdlib -nostdinc --specs=nosys.specs -DDUCK -D__LIB_MUSL__ -Wl,-dynamic-linker,/lib/ld-musl-armv7-a.so -Leggs/libm -Leggs/libm/lib -L../libmusl -L../libmusl/lib -Leggs/libgcc -Leggs/libgcc/lib -L. -L/opt/local/lib/gcc/arm-none-eabi/8.3.0/ -lmusl -lm -lgcc -march=armv7-a -fPIC -g
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -nostdlib -nostartfiles -e _start -g -mcpu=cortex-a7 -mtune=cortex-a7 -mfpu=vfpv4 -mfloat-abi=softfp ../libmusl/lib/crt1.o ../libmusl/lib/libc.a -Leggs/libm -Leggs/libm/lib -L../libmusl -L../libmusl/lib -Leggs/libgcc -Leggs/libgcc/lib -L. -L/opt/local/lib/gcc/arm-none-eabi/8.3.0/ -lmusl -lm -lgcc  -march=armv7-a -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDSOFLAGS=
