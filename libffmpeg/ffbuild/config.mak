...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-cross-compile --arch=x86 --target-os=linux --cross-prefix=i386-elf- --extra-cflags=' -I../libmusl  -I../libmusl/include  -I../libmusl/obj/include/  -I../libmusl/arch/generic/  -Ieggs/ibmusl/arch/generic/bits  -I../libmusl/arch/i386/  -I../libmusl/arch/i386/bits -I/opt/local/lib/gcc/i386-elf/9.2.0/    -L../libmusl/lib -march=i486  -DDUCK -DX86 -DX86 -I. -I./include -Ilibs/include -g -nostdlib -nostdinc  -fno-builtin  -c -std=c99 -std=gnu99 -w -DI386_PC -DLIBC_POSIX  -march=i486  -DMUSL_MODULE  -D__LIB_MUSL__  -static ' --extra-ldflags='-nostdlib -nostartfiles -e start  -g   ../libmusl/lib/crt1.o ../libmusl/lib/libm.a ../libmusl/lib/libmusl.a /opt/local/lib/gcc/i386-elf/9.2.0/libgcc.a ' --host-extralibs= --enable-gpl --enable-nonfree --enable-static --disable-programs --disable-doc --disable-pthreads --disable-shared
prefix=/usr/local
...
AR_O=$@
AR_CMD=i386-elf-ar
NM_CMD=i386-elf-nm -g
RANLIB=i386-elf-ranlib -D
...
CFLAGS=  -I../libmusl -I../libmusl/include -I../libmusl/obj/include/ -I../libmusl/arch/generic/ -Ieggs/ibmusl/arch/generic/bits -I../libmusl/arch/i386/ -I../libmusl/arch/i386/bits -I/opt/local/lib/gcc/i386-elf/9.2.0/ -L../libmusl/lib -march=i486 -DDUCK -DX86 -DX86 -I. -I./include -Ilibs/include -g -nostdlib -nostdinc -fno-builtin -c -std=c99 -std=gnu99 -w -DI386_PC -DLIBC_POSIX -march=i486 -DMUSL_MODULE -D__LIB_MUSL__ -static -std=c11 -fomit-frame-pointer -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I../libmusl -I../libmusl/include -I../libmusl/obj/include/ -I../libmusl/arch/generic/ -Ieggs/ibmusl/arch/generic/bits -I../libmusl/arch/i386/ -I../libmusl/arch/i386/bits -I/opt/local/lib/gcc/i386-elf/9.2.0/ -L../libmusl/lib -march=i486 -DDUCK -DX86 -DX86 -I. -I./include -Ilibs/include -g -nostdlib -nostdinc -fno-builtin -c -std=c99 -std=gnu99 -w -DI386_PC -DLIBC_POSIX -march=i486 -DMUSL_MODULE -D__LIB_MUSL__ -static -g
...
LD_PATH=-L
DLLTOOL=
WINDRES=i386-elf-windres
DOXYGEN=doxygen
LDFLAGS= -nostdlib -nostartfiles -e start -g ../libmusl/lib/crt1.o ../libmusl/lib/libm.a ../libmusl/lib/libmusl.a /opt/local/lib/gcc/i386-elf/9.2.0/libgcc.a  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDSOFLAGS=
